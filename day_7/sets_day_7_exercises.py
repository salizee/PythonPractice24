...
# Join A and B
print('Joining A and B: ', A.union(B))  # returns a new set, update will affect the subsequent questions
...
age_st = set(age)
print('age_set is smaller than age(the list): ', len(age_st) < len(age))  #definitely from the theory
